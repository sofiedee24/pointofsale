    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="https://flowbite.com" class="flex ms-2 md:me-24">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PointOfSale</span>
        </a>
      </div>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  ...
                  <li>
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Create Order</a>
                  </li>
                  <li>
          ...
          <div class="flex items-center ms-20">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Create Order</a>
                </li>
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Create Order</span>
...
<form class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md max-w-2xl mx-auto" action="#">
  <h5 class="text-2xl font-semibold text-gray-900 dark:text-white text-center mb-6 md:col-span-2">Add Product</h5>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
      ...
      <input type="text" name="name" id="name" placeholder="John Doe"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
        required />
    </div>
    ...
    <div>
      ...
      <input type="number" id="price"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full px-4 py-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
        placeholder="$0.00" required />
    </div>

    <!-- Quantity -->
    <div>
      <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Quantity</label>
      <div
        class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden w-full shadow-sm bg-white dark:bg-gray-800">
        <button type="button" id="decrement-button"
          class="w-10 h-10 flex justify-center items-center text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
          </svg>
        </button>
        <input type="text" id="quantity-input"
          class="w-full text-center text-sm text-gray-800 dark:text-white bg-transparent focus:outline-none h-10"
      ...
      <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Enter a quantity between 0-999.</p>
    </div>

    <!-- Image Upload -->
    <div class="md:col-span-2">
      <label for="image-upload" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">
        Product Image
      </label>
      <input type="file" id="image-upload" accept="image/*"
        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
      <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Upload a product image (JPG, PNG, etc.).</p>
    </div>
    ...
    <div>
      <div class="flex items-center mt-2">
        <input id="hidden" type="checkbox"
          class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-600">
...
<script>
    ...
    <img id="image-preview" src="#" alt="Image Preview" class="mt-4 hidden max-h-64 rounded-lg border" />

...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="#" method="POST" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" >
            @csrf
            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<div class="p-4 sm:ml-64">
   ...
   <h1 class="text-2xl text-dark-400 dark:text-black-500 "> Dashboard </h1> 
   

      <div class="grid grid-cols-4 gap-4 mb-3 rounded-4xl">
        
         <div class="items-start  h-20  bg-gray-50 dark:bg-gray-800 mt-4 ">
          <p class="ms-2 mt-2"> Total Category </p>
            <p class="flex items-center justify-center text-2xl text-gray-400 dark:text-gray-500">
         ...
         <div class="items-start  h-20 rounded-4xl bg-gray-50 dark:bg-gray-800 mt-4">
         ...
         <div class="items-start  h-20 rounded-sm bg-gray-50 dark:bg-gray-800 mt-4">
         ...
         <h1 class="text-2xl text-dark-400 dark:text-black-500 "> Orders </h1> 
         ...
         <p class="ms-2 mt-2"> Total Orders </p>
            <p class="flex items-center justify-center text-2xl text-gray-400 dark:text-gray-500 border:grey">
